...
if (!courseDetail.includes('where: { status: "active"') || !courseDetail.includes("visibleStudentWhere(user)")) {
...
if (!coursesPage.includes('where: { status: "active"') || !coursesPage.includes("visibleStudentWhere(user)")) {
...
if (!coursesRoute.includes('studentCourses: { where: { status: "active"') || !coursesRoute.includes("visibleStudentWhere(user)")) {
