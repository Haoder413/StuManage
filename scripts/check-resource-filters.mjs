...
const files = {
  ...
  "src/components/resource-search-toolbar.tsx": ["全部年级", "未设置年份", "yearInput", 'type="number"', 'min="1900"', 'max="2100"', "请输入 1900—2100 的年份", "全部科目", "全部类型", "学生版＋答案版", "全部清除"],
  "miniprogram/pages/resources/index.js": ['gradeOptions: ["全部年级", "初一", "初二", "初三"]', "yearInput", "applyYearFilter", "filterUnsetYear", "请输入 1900—2100 的年份"],
  "miniprogram/pages/resources/index.wxml": ['type="number"', 'bindconfirm="applyYearFilter"', 'bindtap="filterUnsetYear"'],
};
