...
const required = {
  ...
  "src/app/api/mobile/parent/homework/route.ts": ["GET", "getMobileParentHomework"],
  ...
  "miniprogram/utils/api.js": ["request", "Authorization", "Bearer", "resolveRequestToken"],
  "miniprogram/utils/device-login.js": ["readStoredDeviceKey", "saveDeviceKey", "miniDeviceInfo", "isValidSessionToken"],
  ...
  "miniprogram/pages/homework/index.js": ["parent/homework"],
