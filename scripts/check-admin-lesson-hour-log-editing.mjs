...
assert.match(route, /totalLessonHours: nextTotalLessonHours/, "editing/deleting should adjust student total lesson hours");
assert.match(route, /remainingLessonHours: nextRemainingLessonHours/, "editing/deleting should adjust student remaining lesson hours");
