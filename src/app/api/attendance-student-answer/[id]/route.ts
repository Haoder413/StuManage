...
import { deleteStoredStudentAnswer } from "@/lib/attendance-file-storage";
...
export async function DELETE(_request: Request, { params }: { params: { id: string } }) {
  ...
  await prisma.attendanceStudentAnswer.delete({ where: { id: record.id } });
  await deleteStoredStudentAnswer(record.storedName);
